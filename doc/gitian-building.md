...
git clone https://github.com/sharedexcoin-crypto/sharedexcoin.git
cd sharedexcoin
...
```bash
    ...
    From https://github.com/sharedexcoin-crypto/sharedexcoin
...
For example:
```bash
URL=https://github.com/crowning-/sharedexcoin.git
...
[sharedexcoin/gitian.sigs](https://github.com/sharedexcoin-crypto/gitian.sigs/) repository, or if that's not possible to create a pull
request.
