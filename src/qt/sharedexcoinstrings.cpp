...
QT_TRANSLATE_NOOP("sharedexcoin-core", ""
"Disable all ShareDexCoin specific functionality (Masternodes, Obfuscation, SwiftTX, "
...
"transaction that are not equal 10000 SDC."),
QT_TRANSLATE_NOOP("sharedexcoin-core", ""
...
QT_TRANSLATE_NOOP("sharedexcoin-core", "(39797 could be used only on mainnet)"),
QT_TRANSLATE_NOOP("sharedexcoin-core", "(default: %s)"),
QT_TRANSLATE_NOOP("sharedexcoin-core", "(default: 1)"),
QT_TRANSLATE_NOOP("sharedexcoin-core", "(must be 39797 for mainnet)"),
...
QT_TRANSLATE_NOOP("sharedexcoin-core", "Can't denominate: no compatible inputs left."),
QT_TRANSLATE_NOOP("sharedexcoin-core", "Can't find random Masternode."),
QT_TRANSLATE_NOOP("sharedexcoin-core", "Can't mix while sync in progress."),
...
QT_TRANSLATE_NOOP("sharedexcoin-core", "Copyright (C) 2018 The ShareDexCoin Core Developers"),
...
QT_TRANSLATE_NOOP("sharedexcoin-core", "Error: Can't select current denominated inputs"),
...
QT_TRANSLATE_NOOP("sharedexcoin-core", "Error: You already have pending entries in the Obfuscation pool"),
...
QT_TRANSLATE_NOOP("sharedexcoin-core", "Invalid -onion address: '%s'"),
QT_TRANSLATE_NOOP("sharedexcoin-core", "Invalid -proxy address: '%s'"),
...
QT_TRANSLATE_NOOP("sharedexcoin-core", "Keep N SDC anonymized (default: %u)"),
QT_TRANSLATE_NOOP("sharedexcoin-core", "Keep at most <n> unconnectable transactions in memory (default: %u)"),
QT_TRANSLATE_NOOP("sharedexcoin-core", "Last Obfuscation was too recent."),
QT_TRANSLATE_NOOP("sharedexcoin-core", "Last successful Obfuscation action was too recent."),
...
QT_TRANSLATE_NOOP("sharedexcoin-core", "Mixing in progress..."),
...
QT_TRANSLATE_NOOP("sharedexcoin-core", "No funds detected in need of denominating."),
QT_TRANSLATE_NOOP("sharedexcoin-core", "No matching denominations found for mixing."),
...
QT_TRANSLATE_NOOP("sharedexcoin-core", "Obfuscation is idle."),
QT_TRANSLATE_NOOP("sharedexcoin-core", "Obfuscation options:"),
QT_TRANSLATE_NOOP("sharedexcoin-core", "Obfuscation request complete:"),
QT_TRANSLATE_NOOP("sharedexcoin-core", "Obfuscation request incomplete:"),
...
QT_TRANSLATE_NOOP("sharedexcoin-core", "Use N separate masternodes to anonymize funds  (2-8, default: %u)"),
...
QT_TRANSLATE_NOOP("sharedexcoin-core", "Value more than Obfuscation pool maximum allows."),
