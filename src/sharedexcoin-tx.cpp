...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Sharedexcoin Core sharedexcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  sharedexcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded sharedexcoin transaction") + "\n" +
                               "  sharedexcoin-tx [options] -create [commands]   " + _("Create hex-encoded sharedexcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded sharedexcoin transaction
